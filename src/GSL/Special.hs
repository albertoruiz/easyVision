...
-}
foreign import ccall "gslaux.h gsl_sf_erf" erf :: Double -> Double
...
-}
foreign import ccall "gslaux.h gsl_sf_erf_Z" erf_Z :: Double -> Double
...
foreign import ccall "gslaux.h gsl_sf_bessel_J0_e" gsl_sf_bessel_J0_e :: Double -> Ptr Double -> IO Int
...
foreign import ccall "gslaux.h gsl_sf_exp_e10_e" gsl_sf_exp_e10_e :: Double -> Ptr Double -> IO Int
