...
{                                                                              \
    ...
    IppiPoint dstOffset = {0,0};                                               \
                                                                               \
    F(srcSizeR,dstRoi,ippNearest, 0, &specSize, &initSize);                    \
                                                                               \
    IppiResizeSpec_32f* pSpec=(IppiResizeSpec_32f*)ippsMalloc_8u(specSize);    \
                                                                               \
    H(srcSizeR, dstRoi, pSpec);                                                \
...
RESIZENN(_32f_C1R_NN,ippiResizeGetSize_32f,ippiResizeNearestInit_32f,1,IMF,ippiResizeNearest_32f_C1R)
RESIZENN(_8u_C1R_NN,ippiResizeGetSize_8u,ippiResizeNearestInit_8u,1,IM1,ippiResizeNearest_8u_C1R)
RESIZENN(_8u_C3R_NN,ippiResizeGetSize_8u,ippiResizeNearestInit_8u,3,IM1,ippiResizeNearest_8u_C3R)
