...
int ippiCrossCorrValid_NormLevel_8u32f_C1Rx(Ipp8u* pSrc, int srcStep, IppiSize* srcRoiSize, Ipp8u* pTpl, int tplStep, IppiSize* tplRoiSize, Ipp32f* pDst, int dstStep) {
    return ippiCrossCorrValid_NormLevel_8u32f_C1R(pSrc, srcStep, *srcRoiSize, pTpl, tplStep, *tplRoiSize, pDst, dstStep);
}
...
int ippiSqrDistanceValid_Norm_8u32f_C1Rx(Ipp8u* pSrc, int srcStep, IppiSize* srcRoiSize, Ipp8u* pTpl, int tplStep, IppiSize* tplRoiSize, Ipp32f* pDst, int dstStep) {
    return ippiSqrDistanceValid_Norm_8u32f_C1R(pSrc, srcStep, *srcRoiSize, pTpl, tplStep, *tplRoiSize, pDst, dstStep);
}
