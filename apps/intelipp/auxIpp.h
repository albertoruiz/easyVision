...
int ippiCopy_32f_C1MR(void*,int,void*,int,double,void*,int);
...
int ippiSub_32f_C1R(void*,int,void*,int,void*,int,double);
int ippiMul_32f_C1R(void*,int,void*,int,void*,int,double);
